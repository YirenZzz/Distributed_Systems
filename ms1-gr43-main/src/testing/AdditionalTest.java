...
public class AdditionalTest extends TestCase {
	...
	@Test
	public void testLRU() {
		KVServer server = new KVServer(60000, 3, "LRU");
	...
	@Test
	public void testLFU() {
		KVServer server = new KVServer(60000, 3, "LFU");
	...
	public void testFIFO() {
		KVServer server = new KVServer(60000, 3, "FIFO");
	...
	public void testNoCache() {
		KVServer server = new KVServer(60000, 0, "None");
		Exception ex = null;
