...
public class KVStore implements KVCommInterface {
	...
	public KVMessage put(String key, String value) throws Exception {
		...
		TextMessage responseMsg = receiveMessage();
		logger.info("Received messages, in put: " + responseMsg.getMsg().trim());
		return new KVMessageObject(responseMsg.getMsg().trim());
	}
	...
	public KVMessage get(String key) throws Exception {
		...
		TextMessage responseMsg = receiveMessage();
		if (responseMsg == null) {
			System.out.println("In get, responseMsg is null");
		}
		logger.info("Received messages, in get: " + responseMsg.getMsg().trim());
		return new KVMessageObject(responseMsg.getMsg().trim());
	}
